...
x_data, y_data, label_data, mean_data = read_and_mean('wine_train.csv')
...
with open('wine_train.csv') as test_data:
    ...
    test_data = [data[0:2:1] for data in test]       #取出坐标存储
...
# x_data, y_data, label_data, mean_data2 = read_and_mean('wine_test.csv')
